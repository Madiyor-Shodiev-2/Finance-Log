    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            <div>
                ...
                {{ $weeklyBalance->start_of_week . "-" . $weeklyBalance->end_of_week }}
            </p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-card p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-success-100 p-3 rounded-lg">
                        <span class="material-icons text-success-600">
                            south_west
                        </span>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-card p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        {{ $weeklyBalance->chiqim }}
                    </p>
                    </div>
                    <div class="bg-danger-100 p-3 rounded-lg">
                        <span class="material-icons text-danger-600">
                            north_east
                        </span>
                    </div>
                </div>
